...
#import "CuthbertAppDelegate.h"

@implementation CuthbertAppDelegate 
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.monitor.managedObjectContext = context;
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    NSLog(@"Application entered background; activating background task...");
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CuthbertModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CuthbertModel.sqlite"];
